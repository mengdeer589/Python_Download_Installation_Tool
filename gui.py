...
class WinGUI(Tk):
    def __init__(self):
        ...
        self.tk_label_frame_lw1wssni = self.__tk_label_frame_lw1wssni( self.tk_tabs_menu_0)
        ...
        self.tk_button_save_path = self.__tk_button_save_path( self.tk_label_frame_lw1wssni)
        self.tk_input_path = self.__tk_input_path( self.tk_label_frame_lw1wssni)
        self.tk_select_box_download = self.__tk_select_box_download( self.tk_label_frame_lw1wssni)
        self.tk_check_button_downdload = self.__tk_check_button_downdload( self.tk_label_frame_lw1wssni)
        self.tk_label_frame_lw1wx3j1 = self.__tk_label_frame_lw1wx3j1( self.tk_tabs_menu_0)
        self.tk_button_download_start = self.__tk_button_download_start( self.tk_label_frame_lw1wx3j1)
        self.tk_button_open_path = self.__tk_button_open_path( self.tk_label_frame_lw1wx3j1)
        self.tk_button_download_infor = self.__tk_button_download_infor( self.tk_label_frame_lw1wx3j1)
        self.tk_label_frame_lw1xjzul = self.__tk_label_frame_lw1xjzul( self.tk_tabs_menu_1)
        self.tk_label_file_store = self.__tk_label_file_store( self.tk_label_frame_lw1xjzul)
        self.tk_label_target = self.__tk_label_target( self.tk_label_frame_lw1xjzul)
        self.tk_label_target_file = self.__tk_label_target_file( self.tk_label_frame_lw1xjzul)
        self.tk_input_file_store = self.__tk_input_file_store( self.tk_label_frame_lw1xjzul)
        self.tk_input_target = self.__tk_input_target( self.tk_label_frame_lw1xjzul)
        self.tk_input_target_file = self.__tk_input_target_file( self.tk_label_frame_lw1xjzul)
        self.tk_label_frame_lw1xmj4y = self.__tk_label_frame_lw1xmj4y( self.tk_tabs_menu_1)
        self.tk_button_install_start = self.__tk_button_install_start( self.tk_label_frame_lw1xmj4y)
        self.tk_button_install_infor = self.__tk_button_install_infor( self.tk_label_frame_lw1xmj4y)
    ...
    def __tk_button_save_path(self,parent):
        btn = Button(parent, text="保存路径", takefocus=False,)
    ...
    def __tk_button_open_path(self,parent):
        btn = Button(parent, text="打开路径", takefocus=False,)
    ...
    def __tk_button_install_start(self,parent):
        btn = Button(parent, text="开始安装", takefocus=False,)
    ...
    def __tk_label_lw2524gb(self,parent):
        label = Label(parent,text="Python解释器",anchor="center", )
    ...
    def __tk_label_frame_log(self,parent):
        frame = LabelFrame(parent,text="工作日志",)
